export const tournamentStats = [
  {
    title: "14 Age groups",
    description:
      "Upwards of 400 teams attending. Boys tournament U10 - U18. Girls tournament GU12 - GU18. Age groups relate to season 2026/27.",
  },
  {
...
export const tournamentOverview = {
  title: "THE ACES NATIONALS 2026 FOOTBALL TOURNAMENT",
  paragraphs: [
    "The 18th annual ACES Nationals 2026 football tournament will be held over four weekends in May & June. An invitation only tournament open to elite junior boys and girls football teams, all in with a chance to represent their towns or cities for a shot at the prestigious ACES National title.",
...
export const tournamentSchedule: ScheduleDay[] = [
  { date: "May 30th", label: "Weekend 1", ageGroups: ["U10 boys", "U14 boys"] },
  { date: "June 6th", label: "Weekend 2", ageGroups: ["U11 boys", "U15 boys"] },
  { date: "June 7th", label: "Weekend 2", ageGroups: ["U12 boys", "U16 boys"] },
  { date: "June 13th", label: "Weekend 3", ageGroups: ["U12 girls", "U15 girls"] },
  { date: "June 14th", label: "Weekend 3", ageGroups: ["U13 girls", "U16 girls"] },
  { date: "June 20th", label: "Weekend 4", ageGroups: ["U14 girls", "U18 girls"] },
  { date: "June 21st", label: "Weekend 4", ageGroups: ["U13 boys", "U18 boys"] },
];
...
export const tournamentRules = [
  ...
  },
  {
    title: "Age groups",
    content:
      "Age groups relate to the 2026/27 season. Teams must compete in their correct age group as defined by the FA. Boys tournament U10 - U18. Girls tournament GU12 - GU18.",
  },
  {
    title: "Match format",
    content:
...
export const aboutContent = {
  intro: [
    "The ACES team are looking forward to the 2026 Nationals and the eighteenth anniversary tournament.",
  ...
  growth: [
    "The 2026 event will once again bring together 14 age groups over four weekends, attracting upwards of 400 teams to compete from across Great Britain and abroad all looking to leave Nottingham as Nationals champions.",
    "The first ACES tournament kicked off in Leicester in 2009, hosting 20 league champions from 20 different towns and cities all competing for the National title. Now eighteen years on it has grown to be the event in junior grassroots football.",
